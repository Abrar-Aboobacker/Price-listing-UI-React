      ...
      <Drawer anchor="left" open={open} onClose={handleCloseDrawer}>
        ...
        >
          ...
          >
            <Box sx={{ pt: 2 }}>
              <Avatar
                sx={{ height: "60px", width: "60px", mx: 5 }}
                src={profile}
              />
            </Box>
            <Typography
            ...
            >
              <Sidebarlist
                ...
                icon={<DashboardIcon />}
                name="Dashboard"
                shadow="4px 4px 9px rgba(0, 0, 0, 0.2)"
              />
              <Sidebarlist
                icon={<GrassIcon />}
                name="Perks"
              ...
              <Box sx={{ width: "100%", background: "#e3f5fa" }}>
                ...
                >
                  Logout <PowerSettingsNewIcon sx={{ fontSize: 18, ml: 1 }} />
                </Typography>
              </Box>
            </Box>
          </Box>
      ...
      >
        <Box
          sx={{
            ...
            display: { xs: "block", sm: "none" },
            clipPath: {
              xs: "polygon(0% 0%, 100% 0%, 68% 100%, 0% 100%)",
              sm: "polygon(0% 0%, 80% 0%, 48% 100%, 0% 100%)",
            },
